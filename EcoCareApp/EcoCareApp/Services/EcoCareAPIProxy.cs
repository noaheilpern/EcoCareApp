...
namespace EcoCareApp.Services
{
    class EcoCareAPIProxy
    {
        ...
        private const string DEV_ANDROID_PHYSICAL_URL = "http://10.58.55.3:60653/EcoCareAPI"; //API url when using physucal device on android
        ...
        private const string DEV_ANDROID_PHYSICAL_PHOTOS_URL = "http://10.58.55.3:60653/Images/"; //API url when using physucal device on android
